...
function Comments({
  ...
  let comlabel =
    count === 1 ? "comment_count_singular" : "comment_count_plural";

  let countRow = (
    <div className="countRow noselect">
      <div className="likeCount">
        <LikeUI item={itemState} likes={likes} memberMap={memberMap} />
      </div>
      <div className="commentCount">
        <img src={comment} className="commentimg" />
        {label(comlabel, [count + ""])}{" "}
      </div>
    </div>
  );
