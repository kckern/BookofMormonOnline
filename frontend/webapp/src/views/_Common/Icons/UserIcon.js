...
const UserIcon = ({ fill = '#ffffff', className }) => {
  return (
    <>
    ...
    <g id="XMLID_1315_">
        <g>
            <g>
                <ellipse fill={fill} cx="229.5" cy="161" rx="71.5" ry="84"/>
                <path fill={fill} d="M229.5,0C102.686,0,0,102.77,0,229.5C0,355.823,102.191,459,229.5,459C355.989,459,459,356.656,459,229.5
