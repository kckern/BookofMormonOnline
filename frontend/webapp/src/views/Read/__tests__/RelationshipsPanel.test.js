...
const rows = [
  ...
  },
  {
    ...
    src_type: "object", src_slug: "plates-of-brass", src_name: "Plates of Brass",
...
describe("RelationshipsPanel", () => {
  ...
  test("clicking src name opens the source entity popup", () => {
    ...
    expect(mockSetPopUp).toHaveBeenCalledWith({ type: "object", ids: ["teancum-javelin"], underSlug: "objects" });
  });
